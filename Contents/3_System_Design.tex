...
Từ những yêu cầu đã nêu ở Chương 2, lựa chọn STM32F407VET6 là vi điều khiển xử lý trung tâm:
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Chống nhiễu.
        \item Tốc độ cao, hỗ trợ TCP, UDP.
...
\FloatBarrier
\textbf{a. Giải mã, gửi giá trị màn hình và phát hiện phiên bơm}
...
\begin{figure}[!ht]
     \centering
    \includegraphics[width=0.8\linewidth]{Figures/DeviceService_implementation-sequence-ota.png}
